...
class OngoingSection extends StatefulWidget {
  const OngoingSection({Key? key}) : super(key: key);

  @override
  State<OngoingSection> createState() => _OngoingSectionState();
}

class _OngoingSectionState extends State<OngoingSection> {
  final searchEpsController = TextEditingController();
  final List<Map<String, dynamic>> epsAnime =
      List.generate(20, (index) => {"id": index, "judul": "Judul $index"})
          .toList();
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    _foundEps[index]["judul"].toString(),
                                    style: TextStyle(
                                        color: Colors.white,
